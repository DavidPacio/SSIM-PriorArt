...
Admin/www/UK-GAAP-DPL/DimensionsMap.php

Lists Dimensions and Dimension Member info.

History:
30.09.12 Started based on UK-GAAP version
05.10.12 Unique DiMe Ref column added
07.10.12 Requires reduced with ShortNames arrays used to replace previous more obscure code
09.11.12 Ouput of the Start pseudo DiMeId removed with advent of the Bro Class
05.04.13 Unique DiMe Ref column removed
20.04.13 Removed Entity Types column and note
         Removed everything to do with MType
...
Head("Dimensions Map: $TxName", true);
echo "<h2 class=c>$TxName Dimensions Map $titleExtra Listing</h2>
<p class=c>For a simple list of Dimensions without the Dimension Members and Map info see <a href='DimensionsList.php'>Dimensions List</a>.<br>",
...
<p class='c mb0'><button class='on m05'>Dimensions Map</button></p>
</form>
</div>
";
Footer(true,true);
...
function DiMeInfo($bits) {
  ...
  for ($b=1; $b<=DiMeB_Zilch; $b*=2) {
    ...
    switch ($b) {
     ...
     #case DiMeB_M:                     break;
     #case DiMeB_Prop:                  break;
      case DiMeB_RO:     $type .= 'R,'; break;
      case DiMeB_SumKids:
      case DiMeB_SumList:
